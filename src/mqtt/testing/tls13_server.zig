...
const tls_test = @import("../../tls/testing.zig");
...
pub const certificate_base64 = tls_test.certificate_base64;
pub const certificate_der_len = tls_test.certificate_der_len;
