...
- HTTP/3 frame, SETTINGS, DATAGRAM, request/response HEADERS+DATA helpers,
  ...
  zero-reference short-circuits, restricted-reference scan fallback, O(1) FIFO
  eviction index retirement, and indexed QPACK static-name lookups with
  pseudo-header fast paths,
