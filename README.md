...
- QUIC varints, long-header parsing, stream IDs, transport parameters, and core
  ...
  rejection, NEW_CONNECTION_ID receive/send active-limit, single-pass receive/send duplicate-CID/reset-token validation and cursor-backed RETIRE_CONNECTION_ID lifecycle/preflight state with NEW/RETIRE CID-error close mapping wired into
