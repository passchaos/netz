...
- QUIC varints with encode length reuse, long-header parsing, stream IDs, transport parameters, and core
  ...
  receive-frame semantic preflight before multi-frame side effects, preallocated single-, double-, triple-varint, variable-payload, CRYPTO, STREAM, and DATAGRAM frame writes, and direct adaptive truncated packet-number
