...
- QUIC varints with encode length reuse and preallocated writes, long-header parsing, stream IDs, transport parameters, and core
  ...
  ClientHello/ServerHello/EncryptedExtensions/Finished encoding with preallocated handshake messages, cipher-suite vectors, extension wrappers, and fixed-width integer writes plus parsing,
