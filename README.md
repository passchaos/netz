...
- QUIC varints, long-header parsing, stream IDs, transport parameters, and core
  ...
  packet-number space ACK tracking with bounded duplicate/old packet suppression, ACK range semantic validation, never-sent ACK range preflight before multi-frame receive side effects, and adaptive truncated packet-number
