...
- HTTP/3 frame headers, single-varint control frames, PUSH_PROMISE, and unidirectional stream prefixes with small-varint write fast paths, SETTINGS, DATAGRAM, request/response HEADERS+DATA helpers,
