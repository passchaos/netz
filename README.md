...
- QUIC varints with encode length reuse, long-header parsing, stream IDs, transport parameters, and core
  ...
  receive-frame semantic preflight before multi-frame side effects, preallocated single-, double-, triple-varint, variable-payload, CRYPTO, STREAM, DATAGRAM, NEW_CONNECTION_ID, and close frame writes, and direct adaptive truncated packet-number
