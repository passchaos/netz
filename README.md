...
- HTTP/2 frame headers, RFC-bounded SETTINGS validation, DATA/HEADERS (including PADDED/PRIORITY)/PRIORITY/CONTINUATION/RST_STREAM payload parsing and active-stream reset propagation, a bootstrap
  ...
  outbound frame splitting, frame-envelope and stream-id direction validation, request/response trailers, interim 1xx response skipping, content-length
