...
- HTTP/3 frame headers, single-varint control frames, and unidirectional stream prefixes with small-varint write fast paths, SETTINGS, DATAGRAM, request/response HEADERS+DATA helpers,
