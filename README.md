...
- HTTP/3 frame, SETTINGS, DATAGRAM, request/response HEADERS+DATA helpers,
  ...
  plus an indexed generic origin-keyed idle pool with empty-pool miss fast paths, chunked case-folded hashing, and single-lookup release checks for runtime-specific
