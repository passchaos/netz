...
- QUIC varints, long-header parsing, stream IDs, transport parameters, and core
  ...
  validated path MTU,
  an indexed 1-RTT recovery queue with single-lookup group/packet insertion, empty-index group/packet checks, cached newest retransmission packet numbers, and aggregate queue stats for PTO plus packet-threshold and time-threshold
