...
- HTTP/3 frame headers with preallocated generic writes, SETTINGS, single-varint control frames, PUSH_PROMISE/PRIORITY_UPDATE, DATAGRAM/Capsule, and unidirectional stream prefixes with preallocated small-varint write fast paths, request/response HEADERS+DATA helpers,
