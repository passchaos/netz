...
- MQTT 3.1.1/5 fixed headers, CONNECT/CONNACK with Last Will and
  ...
  QoS 2 exactly-once publish handshakes with unsolicited PUBREL rejection, including MQTT v5 PUBACK/PUBREC/PUBREL/PUBCOMP reason-code/property validation with minimal reason-only encoding and negative publish acknowledgement propagation
