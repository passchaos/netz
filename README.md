...
- QUIC varints, long-header parsing, stream IDs, transport parameters, and core
  ...
  ACK-range retirement, O(1) tail ACK/copy removal, single-pass sent-packet
  tracker stats, exact frame wire-length prediction,
