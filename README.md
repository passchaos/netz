...
- QUIC varints, long-header parsing, stream IDs, transport parameters, and core
  ...
  rejection, NEW_CONNECTION_ID receive/send active-limit, duplicate-CID/reset-token validation and RETIRE_CONNECTION_ID lifecycle/preflight state with CID-error close mapping wired into
