...
- QUIC varints, long-header parsing, stream IDs, transport parameters, and core
  ...
  filtering with export/restore snapshots, Retry datagram issue/validate helpers, client-side Retry
  ...
  0-RTT replay filters with explicit expiry pruning and next-expiry observability
  for worker handoff, and a lease-backed
  ...
  endpoint-level timer scheduler for multi-connection loops, and
