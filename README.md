...
- HTTP/3 frame headers, SETTINGS, single-varint control frames, PUSH_PROMISE/PRIORITY_UPDATE, and unidirectional stream prefixes with small-varint write fast paths, DATAGRAM, request/response HEADERS+DATA helpers,
